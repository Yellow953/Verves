        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative order-2 md:order-1">
              {/* Decorative Shapes */}
              <div className="absolute -top-10 -left-10 w-72 h-72 bg-gradient-to-br from-blue-500/20 to-blue-300/20 rounded-full blur-3xl"></div>
              <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-gradient-to-br from-blue-400/20 to-blue-600/20 rounded-full blur-3xl"></div>
              ...
              {/* Floating Elements */}
              <div className="absolute top-20 -right-8 w-16 h-16 bg-blue-500 rounded-2xl -rotate-12 opacity-20"></div>
            ...
            <div className="order-1 md:order-2">
              ...
              <a
                href="/register"
                className="inline-block bg-gradient-to-r from-blue-600 to-blue-800 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-blue-700 hover:to-blue-900 transition-all transform hover:scale-105 shadow-lg"
              >
                Start Your Journey
              </a>
            </div>
